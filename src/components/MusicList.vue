...
<template>
  <div class="music-list">
    ...
    >
      ...
      <el-table-column label="音乐标题" >
        <template #default="scope">
          <div style="display: flex; align-items: center;">
            ...
            <el-icon v-if="scope.row.isListenFee" :size="18" color="#ec4141" style="margin-left: 5px;">
      ...
      <el-table-column prop="artist" label="歌手" :width="widths.singer" />
      <el-table-column v-if="showAlbum" prop="album" label="专辑" :width="widths.album" />
      <el-table-column label="时长" :width="widths.interval">
        <template #default="scope">
          <span>{{scope.row.songTimeMinutes}}</span>
        </template>
      </el-table-column>
    </el-table>
  </div>
